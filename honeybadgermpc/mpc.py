...
def share_in_context(context):
    class GFElementFuture(asyncio.Future):
        ...
        def __binop_field(self, other, op):
            ...
            """
            if isinstance(other, (Share, ShareFuture)):
                res = ShareFuture()
            elif isinstance(other, (GFElement, GFElementFuture)):
                res = GFElementFuture()
            else:
    ...
    class Share(object):
        ...
        # TODO: make this follow VIFF's data flow design
        # https://github.com/initc3/HoneyBadgerMPC/issues/234
        def __mul__(self, other):
    ...
    # TODO: can't divide share by shared future
