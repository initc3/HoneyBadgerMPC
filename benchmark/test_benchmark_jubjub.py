...
TEST_CURVE = Jubjub()
TEST_POINT = Point(5, 6846412461894745224441235558443359243034138132682534265960483512729196124138, TEST_CURVE)  # noqa: E501
...
@mark.parametrize("multiplier", ALL_BIT_NUMBERS)
def test_benchmark_shared_point_montgomery_mul(
        benchmark_runner, multiplier):
    async def _prog(context):
        base = SharedPoint.from_point(context, TEST_POINT)
