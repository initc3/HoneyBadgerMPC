...
#@mpc
#async def breed(ctx, mom_genome, dad_genome, mom_id, dad_id, db, callback):
#    """
...
#    @param mom_id token ID of mom on Ethereum
#    @param dad_id token ID of dad on Ethereum
...
#    # mix the mom_genome and dad_genome bits
#    '''
#    Chang's code goes here -- see robohash.py
#    Specifically: https://github.com/jiaochangyang/Robohash/blob/master/robohash/robohash.py#L75-L92
#
#    where it uses random function rfunc(), for each of mom_genome and dad_genome,
#    use randomness to decide if we want to select that "bit bucket" from
#    the secret genome instead of the "normal" genome
#    (do this part last since it is hardest)
#    '''
#    child_genome = 'public mixed result from _mix_hashes() style functionality'
...
#    success = callback(mom_id, child_genome)
